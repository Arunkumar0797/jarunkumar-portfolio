...
//basic-info function
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    const sections = document.querySelectorAll('.section'); // Replace with your actual section selectors


    // Close sidebar info when clicking outside
    ...
    // Automatically deactivate sidebar when navigating to another section
